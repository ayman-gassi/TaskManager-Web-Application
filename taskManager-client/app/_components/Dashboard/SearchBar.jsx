...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    <div className="flex justify-between items-center mb-8">
      ...
      <div className="flex items-center gap-2 ml-4 mr-[30px] transition-all duration-300">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 top-full mt-1 w-[200px] bg-white border border-[#BEBEC6] rounded-lg shadow-lg py-1">
              <button className="w-full px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 text-left transition-all duration-200 flex items-center gap-2">
